...
public class WifiBean implements Comparable<WifiBean> {
    public final static int ITEM_WIFI =100;
    public final static int ITEM_AVAILABLE =80;
    ...
    public WifiBean(String ssid, String mac, String capabilities, int signalLevel, boolean encrypted) {
        this();
