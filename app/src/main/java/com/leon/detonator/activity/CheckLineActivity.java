...
public class CheckLineActivity extends BaseActivity {
    ...
    private final Handler myHandler = new Handler(msg -> {
        ...
        switch (msg.what) {
            ...
            case DETECT_CONTINUE: //开始检测
                ...
                flowStep = flowStep == 0 ? STEP_SCAN_CODE : STEP_CLEAR_STATUS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.title_single_check_detonator);
        ...
        if (btnDetect.isEnabled())
            switch (keyCode) {
                case KeyEvent.KEYCODE_1:
                    flowStep = -1;
                    BaseApplication.writeFile(getString(R.string.title_single_check_detonator));
                    myHandler.sendEmptyMessage(DETECT_CONTINUE);
                    break;
