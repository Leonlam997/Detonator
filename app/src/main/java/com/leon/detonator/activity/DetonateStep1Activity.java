            ...
            switch (message.what) {
                ...
                case 3:
                    ...
                    if (null != lastLatLng && (int) lastLatLng.latitude != 0 && (int) lastLatLng.longitude != 0) {
                        coordinate = String.format(Locale.CHINA, getString(R.string.map_position), lastLatLng.longitude, lastLatLng.latitude);
                        ...
                        coordinate = String.format(Locale.CHINA, getString(R.string.map_position), settingBean.getLongitude(), settingBean.getLatitude());
                    } else
