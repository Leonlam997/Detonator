...
public class MethodUtils {
    public final static String METHOD_ONLINE_DOWNLOAD = "MBOnlineDownloadRule";
    public final static String METHOD_OFFLINE_DOWNLOAD = "MBOfflineDownloadRule";
    public final static String METHOD_UPLOAD_RECORDS = "MBDetonatorUploadRule";
