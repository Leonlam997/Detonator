...
public class ConstantUtils {
    ...
    public final static int DEFAULT_SINGLE_WORK_VOLTAGE = 80;
    public final static int INITIAL_VOLTAGE_DELAY = 400;
    ...
    public final static int RESEND_TIMES = newLG ? 3 : 8;
    public final static int RESEND_CMD_TIMEOUT = newLG ? 300 : 800;
    public final static int INITIAL_TIME = newLG ? 100 : 8000;
